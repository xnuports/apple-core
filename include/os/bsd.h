...
/*
 * darwintools note: vendored from Apple Libc (libdarwin/h/bsd.h, installed as
 * <os/bsd.h>), absent from the public macOS SDK.  The libdarwin-private
 * <os/api.h> include and its TAPI block are dropped; the availability macros
 * it would supply are neutralized below so the header stands alone.  The OS_*
 * attribute macros come from <os/base.h>.  API surface is unchanged.
 */
#ifndef DARWIN_API_AVAILABLE_20170407
#define DARWIN_API_AVAILABLE_20170407
#endif
#ifndef DARWIN_API_AVAILABLE_20210428
