...
/*
 * Code signature flags returned by csops(CS_OPS_STATUS).
 * The flag bits below are only present in the internal-SDK variant of this
 * header (not in the open-source xnu copy); values are stable and match
 * the codesign(1) ecosystem. Only what userspace consumers need is listed.
 */
#ifndef CS_VALID
#define CS_VALID                0x00000001  /* digitally signed */
#define CS_ADHOC                0x00000002  /* ad-hoc signed */
#define CS_GET_TASK_ALLOW       0x00000004  /* has get-task-allow */
